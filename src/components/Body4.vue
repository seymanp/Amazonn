<template>
    ...
    line-height: 27.3px!important;">Bilgisayar kategorisinde çok satanlar</a>
            <a href="#" style="font:21px;color: blue; font-family:Arial,sans-serif;font-weight: 400;">
                        Daha fazla göster</a>

        </div>
        <ul class="row" style="width: 5000px;">
            <li  v-for="(Body4,index) in Urunler" :key="index">
                <a href="#"><img  v-bind:src="Body4.image" class="product-image" height="200px">
                </a>
            </li>
